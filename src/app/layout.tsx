...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "GAP coverage custom truck",
    "umbrella insurance truck",
  ...
  openGraph: {
    ...
    description:
      "Specialized insurance for custom and modified trucks — agreed value coverage, custom parts & equipment, physical damage, liability, non-trucking, and GAP. All 50 states. 15-min quotes.",
    images: [{ url: "/images/og-image.jpg", width: 1200, height: 630, alt: `${SITE.name} — custom truck coverage` }],
  },
  twitter: {
    card: "summary_large_image",
    title: `${SITE.name} | Contractors Choice Agency`,
    description:
      "Specialized insurance for custom and modified trucks. Agreed value, custom parts, physical damage, liability, non-trucking, and GAP. 15-minute quotes.",
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  const orgSchema = {
    ...
    serviceType: [
      "Agreed Value Custom Truck Insurance",
      "Custom Parts & Equipment Insurance",
